    ...
    <div>
      <div className=" my-10">
        <h2 className=" flex justify-center text-sm md:text-xl font-semibold">
          ...
          <span className="text-blue-500 ">&nbsp;&nbsp;I&nbsp;&nbsp;</span>H A V
          E &nbsp;&nbsp;
          <span className="text-blue-500 ">T O U C H E D</span>
        </h2>
        <div className=" mt-10 grid justify-center items-center align-middle grid-cols-3 grid-rows-4 md:grid-cols-4 lg:grid-cols-5 md:grid-rows-3 gap-5 my-5 px-0 md:px-20">
